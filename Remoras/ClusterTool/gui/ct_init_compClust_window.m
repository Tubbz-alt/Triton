...
bgColor5 = [0.61 .51 0.74]; % light purple
...
%% plot options
labelStr = 'Plot Parameters';
btnPos=[x(1) y(17) w*2 h-ybuff];
REMORA.ct.CC_verify.cparamtext = uicontrol(REMORA.fig.ct.CC_settings, ...
    'Style','text', ...
    'Units','normalized', ...
    'Position',btnPos, ...
...
%% Min and Max Frequency settings
labelStr = 'Set Mean Spectra Plot Min/Max Freq.';
btnPos=[x(1) y(18) w*2 dy];
REMORA.ct.CC_verify.setPlotParams = uicontrol(REMORA.fig.ct.CC_settings,...
   'Style','checkbox',...
   'Units','normalized',...
   'Position',btnPos,...
   'String',sprintf(labelStr,'Interpreter','tex'),...
   'Value',REMORA.ct.CC_params.setPlotPar,...
   'FontUnits','normalized',...
   'Visible','on',...
   'Callback','ct_cc_control(''setPlotPar'')'); 
...
%% Min Frequency Text
labelStr = 'Min. Freq.(kHz)';
btnPos=[x(1) y(19)-ybuff w*.66 h];
REMORA.ct.CC_verify.specPlotMinTxt = uicontrol(REMORA.fig.ct.CC_settings,...
   'Style','text',...
   'Units','normalized',...
   'Position',btnPos,...
   'String',sprintf(labelStr,'Interpreter','tex'),...
   'FontUnits','normalized', ...
   'Visible',showPlotParams);%   'BackgroundColor',bgColor3,...

% Min Freq Editable Text
labelStr=num2str(REMORA.ct.CC_params.minFreq);
btnPos=[x(1)+w*.66 y(19) w/3 h];
REMORA.ct.CC_verify.specPlotMinEdTxt = uicontrol(REMORA.fig.ct.CC_settings,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
    'String',labelStr,...
    'FontUnits','normalized', ...
    'Visible',showPlotParams,...
    'Callback','ct_cc_control(''setSpecPlotMin'')');

%% Max Frequency Text
labelStr = 'Max. Freq.(kHz)';
btnPos=[x(2) y(19)-ybuff w*.80 h];
REMORA.ct.CC_verify.specPlotMaxTxt = uicontrol(REMORA.fig.ct.CC_settings,...
   'Style','text',...
   'Units','normalized',...
   'Position',btnPos,...
   'String',sprintf(labelStr,'Interpreter','tex'),...
...
% Max Freq Editable Text
labelStr=num2str(REMORA.ct.CC_params.maxFreq);
btnPos=[x(2)+w*.66 y(19) w/3 h];
REMORA.ct.CC_verify.specPlotMaxEdTxt = uicontrol(REMORA.fig.ct.CC_settings,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
    ...
    'FontUnits','normalized', ...
    'Visible',showPlotParams,...
    'Callback','ct_cc_control(''setSpecPlotMax'')');
%% Output
